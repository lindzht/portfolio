...
Projskill.create!(project_id: p2.id, skill_id: s10.id)
...
Projskill.create!(project_id: p3.id, skill_id: s3.id)
...
Projskill.create!(project_id: p4.id, skill_id: s20.id)
Projskill.create!(project_id: p4.id, skill_id: s7.id)
Projskill.create!(project_id: p4.id, skill_id: s18.id)

# p5 skills
Projskill.create!(project_id: p5.id, skill_id: s12.id)
Projskill.create!(project_id: p5.id, skill_id: s9.id)
Projskill.create!(project_id: p5.id, skill_id: s6.id)
Projskill.create!(project_id: p5.id, skill_id: s7.id)
Projskill.create!(project_id: p5.id, skill_id: s18.id)

#p6 skills
Projskill.create!(project_id: p6.id, skill_id: s1.id)
Projskill.create!(project_id: p6.id, skill_id: s2.id)
Projskill.create!(project_id: p6.id, skill_id: s4.id)
Projskill.create!(project_id: p6.id, skill_id: s5.id)
Projskill.create!(project_id: p6.id, skill_id: s7.id)
Projskill.create!(project_id: p6.id, skill_id: s8.id)
Projskill.create!(project_id: p6.id, skill_id: s9.id)
Projskill.create!(project_id: p6.id, skill_id: s14.id)
